...
<body>
  <div class="container col-lg-6 mx-auto mt-2 bg-dark text-light text-center ">
  ...
  <nav class="navbar navbar-expand-lg navbar" style="background-color: #e3f2fd;">
    <div class="container">
      <a class="navbar-brand" href="#">All Assignment</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="#">Older</a>
        </li>
      </div>
    </div>
  </nav>
  ...
  <div class="card col-lg-5 mx-auto mt-5">
    ...
    <div class="card-body">
      ...
      <input value="<?= isset($_SESSION['old']['name']) ? $_SESSION['old']['name'] : '' ?>" name="name" class="form-control mt-2 mb-3" type="text" placeholder="Type your name">
      <?php
